...
The Field Canvas can be panned and zoomed using the mouse wheel or trackpad. You can zoom the Field Canvas by holding the Ctrl key and scrolling the mouse wheel or trackpad. Press Ctrl + + to zoom in and Ctrl + - to zoom out.
