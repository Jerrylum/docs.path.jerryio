...
- **Config Accordion** - The panel for control configurations, for example, x and y coordinates, heading, etc.
...
There are four action buttons in the control accordion:
- Rotate Right 90° - Rotates the selected control points 90° clockwise. The center of rotation is the center of all the selected control points.
- Rotate Left 90° - Rotates the selected control points 90° counterclockwise. The center of rotation is the center of all the selected control points.
- Flip Horizontally - Flips the selected control points horizontally. The mirror line is the center of the field.
- Flip Vertically - Flips the selected control points vertically. The mirror line is the center of the field.
...
The field image is displayed in the background of the Field Canvas. It can be changed in the General Config Accordion. See more details in the [General Config Accordion](#general-config-accordion) section. To customize the field image, you can use the [Asset Manager](#asset-manager).
