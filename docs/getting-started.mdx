...
![Bézier Spline and Path](user-guide/img/bezier-spline-and-paths-concept.png)
...
If you want to learn more about PATH.JERRYIO, you can check out the [Concepts](user-guide/concepts) page to learn more about the concepts behind PATH.JERRYIO. You can also check out the [User Interface](user-guide/user-interface) page to learn more about the user interface of PATH.JERRYIO.
