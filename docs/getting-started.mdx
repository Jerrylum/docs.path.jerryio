...
<ReactPlayer playing loop url="/img/getting-started-select-multiple-controls.mp4" style={{margin: "20px 0", maxWidth: "100%"}} />
...
<ReactPlayer playing loop url="/img/getting-started-moving-around.mp4" style={{margin: "20px 0", maxWidth: "100%"}} />
...
The editor is divided into three sections: the left section contains the application menu and path tree, the middle section contains the path editor, and the right section contains all the config panels. To learn more about the user interface, please check out the [User Interface](User-Interface) page.
...
> :warning: **Save As** and **Save** are not supported on Firefox. They are replaced by **Download As** and **Download**.
...
If you want to learn more about PATH.JERRYIO, you can check out the [Concepts](Concepts) page to learn more about the concepts behind PATH.JERRYIO. You can also check out the [User Interface](User-Interface) page to learn more about the user interface of PATH.JERRYIO.
